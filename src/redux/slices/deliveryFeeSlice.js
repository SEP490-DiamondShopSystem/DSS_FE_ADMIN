...
export const fetchDeliveryFees = createAsyncThunk('deliveryFee/fetchAll', async ({isLocation}) => {
...
export const calculateDeliveryFee = createAsyncThunk('deliveryFee/calculate', async (params) => {
...
export const addDeliveryFee = createAsyncThunk('deliveryFee/add', async (deliveryFee) => {
	const response = await api.post('/DeliveryFee', deliveryFee);
	return response;
});

// Update delivery fee
export const updateDeliveryFee = createAsyncThunk('deliveryFee/update', async (deliveryFee) => {
	const response = await api.put('/DeliveryFee', deliveryFee);
	return response;
});

export const deleteDeliveryFee = createAsyncThunk('deliveryFee/delete', async (id) => {
	const payload = {
		deliveryFeeIds: [id],
	};
...
export const setActiveDeliveryFee = createAsyncThunk('deliveryFee/setActive', async (id) => {
	const payload = {
		deliveryFeeIds: [id],
	};
	const response = await api.put(`/DeliveryFee/SetActive`, payload);
	return id;
});
